...
namespace Nudge.Controllers
{
    public class PersonneController : Controller
    {
        ...
        public PersonneController(NudgeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var personne = await _context.Personne
                .Include(s => s.ListeDefi)
                .Include(s => s.ListeTrophee)
                .AsNoTracking()
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom,Prenom,LienPhoto,AdresseMail,NumTel")] Personne personne)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom,Prenom,LienPhoto,AdresseMail,NumTel")] Personne personne)
        {
            if (id != personne.Id)
            {
                return NotFound();
